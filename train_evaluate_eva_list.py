...
from RLestimator_direct import *
...
if inference:
    MODEL_PATH = "models/20210621_1311/"
    ...
    for n in range(0,num_policy):
        ...
        cost_list_ekf.append(mean_cost_ekf)
        cost_list_rl.append(mean_cost_rl)
    ...
    print(cost_list_ekf)
        ...
        # )
        # ax3.plot(
        #         t, cost_ekf_mean_path, color="g", linestyle="dashed", label=("EKF mean cost"),
        #     )
        # # ax3.fill_between(
        # #     t,
