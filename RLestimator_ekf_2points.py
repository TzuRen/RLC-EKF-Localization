...
class RL_estimator(gym.Env):
    ...
    def __init__(self, T):
        ...
        # initial state
        self.initial_bias = np.random.normal(0, 1, size=(self.STATE_SIZE, 1)) * 0.1
        ...
        self.Cx_obs = np.diag([0.1, 0.1, 0.1, 0.1]) ** 2
    ...
    def step(self, action):
        ...
        # cost function
        cost = -20 * math.sqrt((self.x_RL[0] - self.xTrue[0]) ** 2 + (self.x_RL[1] - self.xTrue[1]) ** 2)
